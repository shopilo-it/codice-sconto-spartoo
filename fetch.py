#!/usr/bin/env python3
"""
Recupero codici sconto Spartoo da shopilo.it
Sursa: https://shopilo.it/negozi/spartoo.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/spartoo.it"
STORE_NAME = "Spartoo"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Spartoo da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-spartoo)"
    }
    try:
